    ...
    <div className='flex flex-col items-center justify-center h-screen w-screen bg-[#0B3295] space-y-10'>
        ...
        <div className='bg-[#FFFFFF] w-[85vw] md:w-[60vw] xl:w-[50vw] h-auto rounded-lg p-10 shadow-xl'>
            <div className='flex flex-col items-center justify-center h-[100%] space-y-10'>
                ...
                <div>
                    <button onClick={fetchSpeeds} className='group flex items-center w-[300px] justify-center gap-2 text-[#FFFFFF] text-lg font-semibold border-[1px] bg-[#144FC4] border-[#144FC4] px-20 py-3 rounded cursor-pointer hover:bg-[#1368E7] hover:border-[#1368E7] transition-all ease-in duration-300'>
                        Start Test
